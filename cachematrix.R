## my functions should they chose to do it, give you the inverse of a sqaure matirx
## functions do that in my testing

## this function createa matrix
